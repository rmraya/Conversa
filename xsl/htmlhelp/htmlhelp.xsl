...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- @outputclass='inheritnum' not supported by the HTML viewer of 
       Microsoft HTML Help (IE8 even when IE11 is available?). -->

  <xsl:template priority="100"
                match="*[contains(@class,' topic/ol ') and 
    (contains(@outputclass, 'inheritnum') or 
