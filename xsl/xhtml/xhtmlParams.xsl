...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="generator-info" select="'XMLmind DITA Converter 3.11.1'"/>
  ...
  <xsl:param name="mathjax-url" 
   select="'https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.9/MathJax.js?config=MML_CHTML;async'"/>
