...
<!--                    LONG NAME: Example List                     -->
<!ENTITY % examplelist.content
                       "EMPTY"
>
<!ENTITY % examplelist.attributes
              "%chapter-atts;"
>
<!ELEMENT  examplelist %examplelist.content;>
<!ATTLIST  examplelist %examplelist.attributes;>


<!--                    LONG NAME: Equation List                     -->
<!ENTITY % equationlist.content
                       "EMPTY"
>
<!ENTITY % equationlist.attributes
              "%chapter-atts;"
>
<!ELEMENT  equationlist %equationlist.content;>
<!ATTLIST  equationlist %equationlist.attributes;>
...
<!ATTLIST  examplelist  %global-atts;  class CDATA "- map/topicref bookmap/booklist bookmap/examplelist ">
<!ATTLIST  equationlist %global-atts;  class CDATA "- map/topicref bookmap/booklist bookmap/equationlist ">
